...
/**
 * Created by guoyifeng on 6/8/18.
 */

/**
 * Helper data structure stored in the in-memory HashMap for the third MapReduce Mapper
 * This operation is to store Co-occurrence Matrix in the memory by a HashMap
 */
